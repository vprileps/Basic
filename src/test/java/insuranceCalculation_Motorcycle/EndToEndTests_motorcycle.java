...
public class EndToEndTests_motorcycle extends TestBase
{
	...
	public void insuranceCalculate(Object obj1) throws Exception
	{
		...
		Assert.assertEquals(priceOptions.getPriceForSelectedOption("Platinum"), testData.get("PriceValidation_Platinum"),
				"Pricing for platimum plan is not matching.");
		Assert.assertEquals(priceOptions.getPriceForSelectedOption("Ultimate"), testData.get("PriceValidation_Ultimate"),
	...
	{
		System.out.println("Inside testDataSupplier");
